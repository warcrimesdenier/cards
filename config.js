module.exports = {
	...
	SOCKJS_URL: 'https://localhost:443/sockjs',
	SOCKJS_SCRIPT_URL: 'http://localhost:443/sockjs-1.1.1.min.js',//'https://cdn.jsdelivr.net/npm/sockjs-client@1/dist/sockjs.min.js', 
	GAME_ID: 1,
