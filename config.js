module.exports = {
	...
	SOCKJS_URL: 'https://localhost:' + process.env.PORT + '/sockjs',
	SOCKJS_SCRIPT_URL: 'http://localhost:' + process.env.PORT + '/www/sockjs-1.1.1.min.js',//'https://cdn.jsdelivr.net/npm/sockjs-client@1/dist/sockjs.min.js', 
	GAME_ID: 1,
